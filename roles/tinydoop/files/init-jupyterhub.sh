...
$JUPYTER_HOME/bin/pip install toree==0.3.0

rm -f $JUPYTER_HOME/bin/beeline
...
#$JUPYTER_HOME/bin/jupyter labextension install @jupyterlab/dataregistry-extension
...
#$JUPYTER_HOME/bin/pip install jupyterlab-s3-browser==0.2.2
#$JUPYTER_HOME/bin/jupyter labextension install jupyterlab-s3-browser
#
